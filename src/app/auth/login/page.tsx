      ...
      <div className="bg-white shadow-lg rounded-xl flex flex-col md:flex-row w-full max-w-[360px] md:max-w-[420px] overflow-hidden">
        ...
        <div className="w-full md:w-full p-4 md:p-8">
          ...
          <p className="text-gray-600 mb-3 text-xs">
            Don't have an account? <Link href="/auth/signup" className="text-green-700 hover:underline">Sign up</Link>
          </p>
            ...
            <div className="mb-3">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center text-gray-600 text-xs">
                  <input type="checkbox" className="form-checkbox mr-1" /> Remember me
                </label>
                <Link href="/auth/forgot-password" className="inline-block align-baseline text-xs text-green-700 hover:underline">
                  Forgot Password?
                </Link>
              </div>
            </div>
        ...
        <div className="hidden md:flex w-full md:w-1/2 bg-green-700 text-white p-4 rounded-r-xl items-center justify-center relative overflow-hidden">
          <Image src="/two.jpg" alt="Computer related image" layout="fill" objectFit="cover" className="absolute inset-0 z-0 opacity-70" />
